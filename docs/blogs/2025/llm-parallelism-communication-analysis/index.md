...
> 强烈建议读者在阅读本文时，先对这些通信原语有一个基本的了解。读者可参考[并行计算集合通信初步](/blogs/2023/introduction-to-parallel-computing-collective-communication/)一文。
...
> 若读者对 FlashAttention[^7] 感兴趣，可参考[图解 Flash Attention](/blogs/2024/illustrated-flash-attention/) 一文。
...
> 有关矩阵乘法的分块计算，读者可参考[分块矩阵的乘法](/blogs/2023/block-matrix-multiplication/)一文。
